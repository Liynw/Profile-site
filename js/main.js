...
const add_id = "t1hlbtfstrzrgse1"; // app_id
const app_secret = "bWVld0wxNktWMHk2Wk56K01jNjBsQT09"; // app_secret
const key = "06f7b8aefd1041fdb1e68e7dcca881e2" // key
function getWeather() {
...
$("#github").mouseover(function () {
    $("#link-text").html("是 Github 账号！");
}).mouseout(function () {
    $("#link-text").html("联系方式(*/ω＼*)");
});
$("#qq").mouseover(function () {
    $("#link-text").html("和博主聊天呀");
}).mouseout(function () {
    $("#link-text").html("联系方式(*/ω＼*)");
});
$("#email").mouseover(function () {
    $("#link-text").html("发邮件也 OK");
}).mouseout(function () {
    $("#link-text").html("联系方式(*/ω＼*)");
});
$("#bilibili").mouseover(function () {
    $("#link-text").html("别看了，没视频");
}).mouseout(function () {
    $("#link-text").html("联系方式(*/ω＼*)");
});
$("#telegram").mouseover(function () {
    $("#link-text").html("欢迎来玩哦");
}).mouseout(function () {
    $("#link-text").html("联系方式(*/ω＼*)");
});
...
$('#switchmore').on('click', function () {
    ...
    if (shoemore && $(document).width() >= 990) {
        ...
        $("#change").html("Oops&nbsp;!");
        $("#change1").html("你居然找到这里来了！ψ(._. )>（ 再点击一次可关闭 ）");
    } else {
        $('#container').attr('class', 'container');
        $("#change").html("Hello&nbsp;World&nbsp;!");
        $("#change1").html("Every little helps.");
    }
});
...
主页:  https://liynw.top
Github:  https://github.com/Liynw/Profile-site
`
