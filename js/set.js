...
/* 尚未完善 */
$(function () {
    let url = "https://cdn.jsdelivr.net/npm/saiodgm-home@1.0.5/setting.json"
    $.getJSON(
        url,
        function (data) {
            /* 页头数据 */
            ...
            $('#telegram').attr('href', "https://twitter.com/" + data.telegram);
            /* 快捷链接 */
...
function setBgImgInit() {
    ...
    switch (bg_img["type"]) {
        case "1":
            $('#bg').attr('src', `https://cdn.jsdelivr.net/npm/saiodgm-api@1.0.1/randomimg-simple/background${randomNum(1, 30)}.webp`) //随机默认壁纸
            break;
        case "2":
