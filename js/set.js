...
/* 尚未完善 */
$(function () {
    let url = "https://cdn.afdelivr.top/npm/saiodgm-home@1.0.4/setting.json"
    $.getJSON(
        url,
        function (data) {
            /* 页头数据 */
...
function setBgImgInit() {
    ...
    switch (bg_img["type"]) {
        case "1":
            $('#bg').attr('src', `https://cdn.afdelivr.top/npm/saiodgm-api@1.0.1/randomimg-simple/background${randomNum(1, 30)}.webp`) //随机默认壁纸
            break;
        case "2":
